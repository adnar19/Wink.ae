...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <link rel="stylesheet" href="<?php echo url.'public/dashboard' ?>/css/Wink-icons.css">
...
<body data-spy="scroll" data-target="#mainmenu" data-offset="80">
    ...
    <header id="header" class="header-section">
        <div class="container">
            <nav class="navbar ">
                <a href="<?php echo url ?>" class="navbar-brand"><img src="<?php echo url.'public/dashboard' ?>/img/logo-dark.png" alt="Saasbiz"></a>
                <div class="d-flex menu-wrap">
                    <div id="mainmenu" class="mainmenu">
                        <ul class="nav">
                            <li><a data-scroll class="nav-link" href="#home">Home</a></li>
                            ...
                            <li><a data-scroll class="nav-link" href="#reviews">Avis</a></li>
    ...
    <section class="testimonial-section pos-rel padding">
        ...
        <div class="container">
            <div class="section-heading mb-40 text-left">


                <h3>Vous avez trouvé un bug de sécurité ? Merci de nous informer en respectant notre charte. Votre geste sera généreusement récompenser !</h3>

                <h2>Règles </h2>
                <p>Vous ne pouvez pas accéder aux données privées d'autres comptes d'utilisateurs, les télécharger ou
                    les enregistrer. Toute attaque visant la disponibilité ou l'intégrité de nos services (par exemple,
                    détruire des données, modifier des données ou supprimer des données) est interdite et non autorisée.
                    Toute attaque susceptible de compromettre la disponibilité ou l'intégrité de nos services (par
                    exemple avec des analyses de vulnérabilité automatisées) est interdite et non autorisée. Les
                    attaques DDoS et spam ne sont pas autorisées.</p>

                    <p>Les problèmes du rapport peuvent ne pas être déjà publiés ou prêts à être publiés. Nous devons disposer de 60 jours pour résoudre le problème (avant divulgation publique ou divulgation à un tiers). Veuillez suivre les principes de base de la divulgation responsable.</p>

                <h2>Portée</h2>

                <p>Les problèmes du rapport peuvent ne pas être déjà publiés ou prêts à être publiés. Nous devons
                    disposer de 60 jours pour résoudre le problème (avant divulgation publique ou divulgation à un
                    tiers). Veuillez suivre les principes de base de la divulgation responsable.</p>

                <p>Le problème concerne l'un des domaines suivants : winch.ae, api.winch.ae . </p>
                <p>

                </p>Le problème signalé ne doit pas déjà être connu ou nous avoir été soumis par une autre personne.
                <p>Le problème doit être un risque que nous n'acceptons pas. Les attaques temporelles, par exemple
                    celles qui permettent de vérifier l'existence d'un utilisateur, ne sont pas incluses dans le
                    programme de primes aux bogues.

                </p>

                <p>Les attaques utilisant la force brute ou les problèmes résultant de l'utilisation de la force brute
                    ne font pas partie du programme.</p>

                <p> Les problèmes identifiés sur les anciens appareils mobiles, systèmes d'exploitation ou navigateurs
                    ne font pas partie du programme.</p>

                <p> Le problème doit être reproductible sur le dernier appareil, système d'exploitation et navigateur
                    (sans extensions de navigateur).</p>
                <h4>Nous remercions tous ceux qui ont travaillé dur pour contribuer à nous rendre plus sûrs. </h4>


                <h4>Si vous souhaitez nous contacter, vous pouvez nous joindre via  vulnerability@wink.ae</h4>
                    ...
                    <div class="col-lg-2 col-sm-6 sm-padding">
                        <div class="widget-content">
                            ...
                            <li><a href="<?php echo url.'home/terms' ?>">Conditions générales d'utilisation</a></li>
                                ...
                                <li><a href="<?php echo url.'home/contact' ?>">Contactez-nous</a></li>
